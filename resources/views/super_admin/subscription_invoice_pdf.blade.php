...
<div class="body">
    ...
    <table class="items-table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="item-name">{{ $subscription->plan->name ?? 'Subscription Plan' }}</div>
                ...
                <td class="right">${{ number_format($lastPayment->amount ?? $subscription->plan->price ?? 0, 2) }}</td>
                <td class="right">${{ number_format($lastPayment->amount ?? $subscription->plan->price ?? 0, 2) }}</td>
            </tr>
        </tbody>
    </table>
    ...
    {{-- Totals --}}
    @php $amount = $lastPayment->amount ?? $subscription->plan->price ?? 0; @endphp
