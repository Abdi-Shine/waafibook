        ...
        <div class="col-lg-7">
            <div class="sa-card">
                <div class="sa-card-head">
                    ...
                    <span class="sa-badge sa-badge-blue">Last 10 actions</span>
                </div>
                    ...
                    <table class="sa-table">
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $action = $parts[0] ?? $log->description;
                                $target = $parts[1] ?? '—';
                            @endphp
                            <tr>
                                <td style="color:#9ca3af;font-size:.78rem;">{{ $log->created_at->format('d M Y, H:i') }}</td>
                                <td>{{ $action }}</td>
                                <td style="font-weight:600;color:#111827;">{{ $target }}</td>
                            </tr>
                            @empty
                            <tr><td colspan="3" class="text-center py-4" style="color:#9ca3af;">No activity recorded yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
