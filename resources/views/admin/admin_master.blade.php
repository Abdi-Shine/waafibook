...
<head>
    ...
    {{-- iOS requires explicit size-tagged links — manifest icons are ignored --}}
        ...
        @php
            $bannerData = match($subscriptionRestrictionReason ?? '') {
                ...
                'pending_approval' => [
                    ...
                    'msg'  => 'Your subscription request is awaiting Super Admin approval. Full access will be enabled automatically once your payment is confirmed.',
                    'btn'  => ['label' => 'View Status', 'url' => route('subscribers.plans.index')],
                ],
                'no_subscription' => [
                    'bg'   => '#fef9c3',
                    'border' => '#facc15',
                    ...
                    'msg'  => 'You don\'t have an active subscription. Choose a plan to get started.',
                    'btn'  => ['label' => 'Choose Plan', 'url' => route('subscribers.plans.index')],
                ],
                default        => [
                    'bg'   => '#fef9c3',
                    'border' => '#facc15',
